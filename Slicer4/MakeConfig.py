...
cf.optionxform = str
cfFileName = 'Slicer3verification/Case'+case+'_VisAIRe.ini'
...
for nid in needleImageIds:
  ...
  tfmFile1 = RegDir+'/'+nidStr+'-IntraIntra-BSpline-Attempt1.tfm'
  tfmFile2 = RegDir+'/'+nidStr+'-IntraIntra-BSpline-Attempt2.tfm'
