...
registrationCmd = "/Applications/Slicer.4.3.app/Contents/lib/Slicer-4.3/cli-modules/BRAINSFit"
resamplingCmd = "/Applications/Slicer.4.3.app/Contents/lib/Slicer-4.3/cli-modules/BRAINSResample"
...
def BFRegister(fixed=None,moving=None,fixedMask=None,movingMask=None,rigidTfm=None,affineTfm=None,bsplineTfm=None,initializer=None,log=None,initTfm=None,initialTfm=None):
  CMD=registrationCmd+" --fixedVolume "+fixed+" --movingVolume "+moving+" --debugNumberOfThreads 1 --maskProcessingMode ROI --numberOfIterations 500 "
  ...
  if bsplineTfm:
    CMD = CMD+" --useROIBSpline --useBSpline --splineGridSize 3,3,3 --outputTransform "+bsplineTfm  
...
RegDir='Data/Case'+case+'/Registration2attempts'
RegDir='Data/Case'+case+'/Slicer4registration'
TempDir='TempDir'
try:
  os.mkdir(RegDir)
except:
